...
const DatePickerField = ({ placeholder = "Select date", isRequired = false, styles = {}, className = "", name, // Name prop to identify this field in the form context
 }) => {
    ...
    return (_jsxs("div", { className: "relative mb-4", children: [_jsx("input", { id: name, ref: inputRef, type: "date", value: formData[name] || "", placeholder: placeholder, onChange: handleInputChange, required: isRequired, className: `bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 
